%load data 
clear
load('Fig4g_trace.mat')
FR = 15.625;
data_all1 = [];
data_all2 = [];
ROI = 59; %ROI6 in FOV5 from M1

%Generalization 
scr=get(0,'ScreenSize');
W=scr(3); H=scr(4);
position=[205,300,210,150];
...
data1 = FZ_tt_all1{ROI, 1}   ;
data2 = FZ_tt_all1{ROI, 2}   ;
...
data1 = FZ_tt_all2{ROI, 1}   ;
data2 = FZ_tt_all2{ROI, 2}   ;
data1 = data1 - mean(data1(:,9:16),2);
data2 = data2 - mean(data2(:,9:16),2);
...
data1 = FZ_tt_all3{ROI, 1}   ;
data2 = FZ_tt_all3{ROI, 2}   ;
data1 = data1 - mean(data1(:,9:16),2);
data2 = data2 - mean(data2(:,9:16),2);
