...
elseif task ==2
    color2 = [0.42 0.329 0.639; 0.984,0.749,0.078];
end
...
fill(xrange,yrange1,color2(1,:),'FaceAlpha',0.1,'EdgeColor','none');hold on
fill(xrange,yrange2,color2(2,:),'FaceAlpha',0.1,'EdgeColor','none');hold on
