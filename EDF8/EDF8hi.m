...
plot(time, Estimate_diff1(:,1),'-','color',[0.18 0.192 0.573],'LineWidth',2.5); hold on
plot(time, Estimate_diff1(:,2),'-','color',[0.106 0.459 0.737],'LineWidth',2.5); hold on
plot(time, Estimate_diff1(:,3),'-','color',[0 0.682 0.937],'LineWidth',2.5); hold on
yline(0,'--')
xlim([-0.5 1])
ylim([-11 10])
yticks([-10 0 10])
