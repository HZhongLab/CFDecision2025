...
plot(time, Estimate_diff1(:,1),'-','color',[0.376 0.224 0.075],'LineWidth',2.5); hold on
plot(time, Estimate_diff1(:,2),'-','color',[0.545 0.369 0.235],'LineWidth',2.5); hold on
plot(time, Estimate_diff1(:,3),'-','color',[0.608 0.522 0.475],'LineWidth',2.5); hold on
xlim([-0.5 1])
ylim([-11 10])
yticks([-10 0 10])
